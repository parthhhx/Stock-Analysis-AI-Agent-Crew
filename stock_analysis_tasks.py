...
class StockAnalysisTasks:
    def research(self, agent, company):
      ...
      """
            ...
            expected_output="Details of the company",
            agent=agent,
        )
    ...
    def financial_analysis(self, agent):
      ...
      """
            ...
            expected_output="Financial details of the company",
            agent=agent,
        )
    ...
    def filings_analysis(self, agent):
      ...
      """
            ...
            expected_output="A summary of data.",
            agent=agent,
        )
    ...
    def recommend(self, agent):
      ...
      """
            ...
            expected_output="Recommendation on how to trade the given stock",
            agent=agent,
        )
